...
<html>
    ...
    <h1 style="text-align: center;font-size: 60px;">Welcome to Edit Employer Page</h1>
        ...
        <tr>
            ...
            <td><input type="text"  name="new_emp_name" id="new_emp_name_id" onkeyup="check_emp_name()">
            <p id="emp_name_val" style="display:none;color: red;">Employee Can not be Null</p>
        </td>
        </tr>
        <tr>
            <td>Company Name</td>
        ...
        <tr>
            ...
            <td><input type="text"  name="new_comp_name" id="new_comp_name_id" onkeyup="check_comp_name()">
            <p id="comp_name_val"  style="display:none;color: red;"> Company Name Can not be Null</p>
        </td>
        </tr>
        <tr>
            <td>Contact No</td>
        ...
        <tr>
            ...
            <p id="contact_no_val"  style="display:none;color: red;"> Contact Can not be Null</p>
        </td>
        </tr>
        <tr>
            <td>Password</td>
        ...
        <tr>
            ...
            <p id="password_val" style="display:none;color: red;"> Password Can not be Null</p>
            </td>
        </tr>
    ...
    <script src="../asset/js/edit_emp.js"></script>
